...
scan_ui_list = [CULTIVATE_MAIN_MENU, CULTIVATE_TRAINING_SELECT,
                CULTIVATE_EVENT_UMAMUSUME, CULTIVATE_EVENT_SCENARIO, CULTIVATE_EVENT_SUPPORT_CARD,
                INFO, BEFORE_RACE, CULTIVATE_RACE_LIST, RACE_REWARD, RACE_RESULT,
                CULTIVATE_GOAL_RACE, NEXT_GOAL, GOAL_ACHIEVED, CULTIVATE_LEARN_SKILL,
                CULTIVATE_RESULT, ACTIVITY_RESULT, CULTIVATE_EXTEND, CULTIVATE_FINISH, FACTOR_RECEIVE,
                ACTIVITY_REWARD, MAIN_MENU,
                CULTIVATE_SCENARIO_SELECT, CULTIVATE_UMAMUSUME_SELECT, CULTIVATE_EXTEND_UMAMUSUME_SELECT,
                CULTIVATE_SUPPORT_CARD_SELECT, CULTIVATE_FOLLOW_SUPPORT_CARD_SELECT, CULTIVATE_FINAL_CHECK,
                CULTIVATE_CATCH_DOLL_GAME, CULTIVATE_CATCH_DOLL_GAME_RESULT, CULTIVATE_LEVEL_RESULT,
                CULTIVATE_RESULT_1, CULTIVATE_RESULT_2,
                CONFIRMATION_LEARNSKILL_BUTTON, RECEIVE_CUP, FRIEND_RECREATION,
                CULTIVATE_URA_RACE_1, CULTIVATE_URA_RACE_2, CULTIVATE_URA_RACE_3,
                IN_RACE_UMA_LIST, IN_RACE, ALL_GOAL_ACHIEVED, GOAL_FAILED,
                HISTORICAL_RATING_UPDATE, SCENARIO_RATING_UPDATE,
                FUJIKISEKI_SHOW_MODE_RESULT_1, FUJIKISEKI_SHOW_MODE_RESULT_2]
